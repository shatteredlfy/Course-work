...
Doctor::Doctor(std::string tmp_fn, std::string tmp_ln, int tmp_d, int tmp_m,
    int tmp_y, int tmp_h, int tmp_w, std::string tmp_em, std::string tmp_spec, 
    int tmp_pc, int tmp_sal, int tmp_cat) 
...
void Doctor::checkInfo()
{
    ...
    if(salary < 6500)
        throw std::invalid_argument("Error..\nSalary can't be less than minimal salary.");
